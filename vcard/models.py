...
class Gallery(SeoAbstractModel):
    title = models.CharField(max_length=200, blank=False, null=False, verbose_name='Название проекта',
    ...
    preview = models.ImageField(upload_to='uploads/gallery/', default='default_project.jpg',
                                verbose_name='Изображение на превью')
    comp_view = models.ImageField(upload_to='uploads/gallery/comp_view/', default='comp_view.jpg',
...
class SiteConfig(models.Model):
    ...
    favicon = models.FileField(upload_to='favicon/', blank=False, default='favicon.ico',
                               verbose_name='Favicon для сайта')

    # ABOUT ME block
    name = models.CharField(max_length=200, blank=False, null=False, verbose_name='Имя на главной')
    nickname = models.CharField(max_length=150, blank=True, null=True, verbose_name='Никнейм на главной')
    specialization = models.CharField(max_length=150, blank=True, null=True, verbose_name='Позиция (специализация)')
    ...
    city = models.CharField(max_length=120, blank=True, null=True, verbose_name='Текущий город')
    ...
    skype = models.CharField(max_length=120, blank=True, null=True, verbose_name='Ссылка на Skype')
